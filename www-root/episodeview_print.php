...
$layout->blocks["top"][] = "pdf";$page_layouts["episodeview_print"] = $layout;
...
$arr = array();
$arr['fName'] = "idEpisode";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("idEpisode");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "idFile";
...
$arr = array();
$arr['fName'] = "strTitle";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("strTitle");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "strStudio";
...
//	idEpisode - 
			$record["idEpisode_value"] = $pageObject->showDBValue("idEpisode", $data, $keylink);
			$record["idEpisode_class"] = $pageObject->fieldClass("idEpisode");
//	idFile - 
...
//	strTitle - 
			$record["strTitle_value"] = $pageObject->showDBValue("strTitle", $data, $keylink);
			$record["strTitle_class"] = $pageObject->fieldClass("strTitle");
//	strStudio - 
...
$xt->assign("idEpisode_fieldheadercolumn",true);
$xt->assign("idEpisode_fieldheader",true);
$xt->assign("idEpisode_fieldcolumn",true);
$xt->assign("idEpisode_fieldfootercolumn",true);
...
$xt->assign("strTitle_fieldheadercolumn",true);
$xt->assign("strTitle_fieldheader",true);
$xt->assign("strTitle_fieldcolumn",true);
$xt->assign("strTitle_fieldfootercolumn",true);
