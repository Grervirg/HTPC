...
$layout->blocks["top"][] = "pdf";$page_layouts["musicvideoview_print"] = $layout;
...
$arr = array();
$arr['fName'] = "idMVideo";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("idMVideo");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "idFile";
...
//	idMVideo - 
			$record["idMVideo_value"] = $pageObject->showDBValue("idMVideo", $data, $keylink);
			$record["idMVideo_class"] = $pageObject->fieldClass("idMVideo");
//	idFile - 
...
$xt->assign("idMVideo_fieldheadercolumn",true);
$xt->assign("idMVideo_fieldheader",true);
$xt->assign("idMVideo_fieldcolumn",true);
$xt->assign("idMVideo_fieldfootercolumn",true);
