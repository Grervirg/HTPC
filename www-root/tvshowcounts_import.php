...
$strOriginalTableName="`tvshowcounts`";
if(!isLogged())
{ 
...
$layout = new TLayout("import","FancyBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "import";$page_layouts["tvshowcounts_import"] = $layout;
...
$xt->display("tvshowcounts_import.htm");
