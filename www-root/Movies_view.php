...
//strFilename - 
	...
	if($mainTableOwnerID=="strFilename")
		$ownerIdValue=$value;
	$xt->assign("strFilename_value",$value);
...
//idPath - 
	...
	if($mainTableOwnerID=="idPath")
		$ownerIdValue=$value;
	$xt->assign("idPath_value",$value);
...
//dateAdded - 
	...
	if($mainTableOwnerID=="dateAdded")
		$ownerIdValue=$value;
	$xt->assign("dateAdded_value",$value);
...
//strPath - 
	...
	if($mainTableOwnerID=="strPath")
		$ownerIdValue=$value;
	$xt->assign("strPath_value",$value);
...
//strGenre - 
	...
	if($mainTableOwnerID=="strGenre")
		$ownerIdValue=$value;
	$xt->assign("strGenre_value",$value);
...
//idGenre - 
	...
	if($mainTableOwnerID=="idGenre")
		$ownerIdValue=$value;
	$xt->assign("idGenre_value",$value);
...
//strSet - 
	...
	if($mainTableOwnerID=="strSet")
		$ownerIdValue=$value;
	$xt->assign("strSet_value",$value);
...
//idSet1 - 
	...
	if($mainTableOwnerID=="idSet1")
		$ownerIdValue=$value;
	$xt->assign("idSet1_value",$value);
...
//strTag - 
	...
	if($mainTableOwnerID=="strTag")
		$ownerIdValue=$value;
	$xt->assign("strTag_value",$value);
...
//idTag - 
	...
	if($mainTableOwnerID=="idTag")
		$ownerIdValue=$value;
	$xt->assign("idTag_value",$value);
