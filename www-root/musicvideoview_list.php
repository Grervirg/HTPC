...
$layout = new TLayout("list6","FancyBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["musicvideoview_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "idMVideo";
																																}
