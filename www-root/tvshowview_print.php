...
$layout->blocks["top"][] = "pdf";$page_layouts["tvshowview_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "idParentPath";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("idParentPath");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "strPath";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "totalCount";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("totalCount");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "watchedcount";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("watchedcount");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "totalSeasons";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("totalSeasons");
$fieldsArr[] = $arr;
...
//	idParentPath - 
			$record["idParentPath_value"] = $pageObject->showDBValue("idParentPath", $data, $keylink);
			$record["idParentPath_class"] = $pageObject->fieldClass("idParentPath");
//	strPath - 
...
//	totalCount - 
			$record["totalCount_value"] = $pageObject->showDBValue("totalCount", $data, $keylink);
			$record["totalCount_class"] = $pageObject->fieldClass("totalCount");
//	watchedcount - 
			$record["watchedcount_value"] = $pageObject->showDBValue("watchedcount", $data, $keylink);
			$record["watchedcount_class"] = $pageObject->fieldClass("watchedcount");
//	totalSeasons - 
			$record["totalSeasons_value"] = $pageObject->showDBValue("totalSeasons", $data, $keylink);
			$record["totalSeasons_class"] = $pageObject->fieldClass("totalSeasons");
			if($col<$colsonpage)
...
$xt->assign("idParentPath_fieldheadercolumn",true);
$xt->assign("idParentPath_fieldheader",true);
$xt->assign("idParentPath_fieldcolumn",true);
$xt->assign("idParentPath_fieldfootercolumn",true);
...
$xt->assign("totalCount_fieldheadercolumn",true);
$xt->assign("totalCount_fieldheader",true);
$xt->assign("totalCount_fieldcolumn",true);
$xt->assign("totalCount_fieldfootercolumn",true);
$xt->assign("watchedcount_fieldheadercolumn",true);
$xt->assign("watchedcount_fieldheader",true);
$xt->assign("watchedcount_fieldcolumn",true);
$xt->assign("watchedcount_fieldfootercolumn",true);
$xt->assign("totalSeasons_fieldheadercolumn",true);
$xt->assign("totalSeasons_fieldheader",true);
$xt->assign("totalSeasons_fieldcolumn",true);
$xt->assign("totalSeasons_fieldfootercolumn",true);
