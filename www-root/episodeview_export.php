...
$layout->blocks["top"][] = "export";$page_layouts["episodeview_export"] = $layout;
...
$xt->display("episodeview_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=episodeview.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=episodeview.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=episodeview.xml");
	...
	{
		$values = array();
			$values["idEpisode"] = $pageObject->showDBValue("idEpisode", $row);
			...
			$values["c17"] = $pageObject->showDBValue("c17", $row);
			...
			$values["idShow"] = $pageObject->showDBValue("idShow", $row);
			$values["strFileName"] = $pageObject->showDBValue("strFileName", $row);
			$values["strPath"] = $pageObject->showDBValue("strPath", $row);
			$values["playCount"] = $pageObject->showDBValue("playCount", $row);
			$values["lastPlayed"] = $pageObject->showDBValue("lastPlayed", $row);
			$values["dateAdded"] = $pageObject->showDBValue("dateAdded", $row);
			$values["strTitle"] = $pageObject->showDBValue("strTitle", $row);
			$values["strStudio"] = $pageObject->showDBValue("strStudio", $row);
			$values["premiered"] = $pageObject->showDBValue("premiered", $row);
			$values["mpaa"] = $pageObject->showDBValue("mpaa", $row);
			$values["resumeTimeInSeconds"] = $pageObject->showDBValue("resumeTimeInSeconds", $row);
			$values["totalTimeInSeconds"] = $pageObject->showDBValue("totalTimeInSeconds", $row);
			$values["idSeason"] = $pageObject->showDBValue("idSeason", $row);
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=episodeview.csv");
...
// write header
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"resumeTimeInSeconds\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"totalTimeInSeconds\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"idSeason\"";
	echo $outstr;
...
// write data rows
	...
	{
		$values = array();
			$values["idEpisode"] = $pageObject->getViewControl("idEpisode")->showDBValue($row, "");
			...
			$values["c17"] = $pageObject->getViewControl("c17")->showDBValue($row, "");
			...
			$values["idShow"] = $pageObject->getViewControl("idShow")->showDBValue($row, "");
			...
			$values["playCount"] = $pageObject->getViewControl("playCount")->showDBValue($row, "");
			$values["lastPlayed"] = $pageObject->getViewControl("lastPlayed")->showDBValue($row, "");
			$values["dateAdded"] = $pageObject->getViewControl("dateAdded")->showDBValue($row, "");
			$values["strTitle"] = $pageObject->getViewControl("strTitle")->showDBValue($row, "");
			$values["strStudio"] = $pageObject->getViewControl("strStudio")->showDBValue($row, "");
			$values["premiered"] = $pageObject->getViewControl("premiered")->showDBValue($row, "");
			$values["mpaa"] = $pageObject->getViewControl("mpaa")->showDBValue($row, "");
			$values["resumeTimeInSeconds"] = $row["resumeTimeInSeconds"];
			$values["totalTimeInSeconds"] = $row["totalTimeInSeconds"];
			$values["idSeason"] = $pageObject->getViewControl("idSeason")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["idEpisode"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["idShow"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["playCount"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["lastPlayed"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["dateAdded"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["strTitle"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["strStudio"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["premiered"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["mpaa"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["resumeTimeInSeconds"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["totalTimeInSeconds"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["idSeason"]).'"';
			echo $outstr;
		}
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Id Episode").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Id File").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C00").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C01").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C02").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C03").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C04").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C05").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C06").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C07").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C08").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C09").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C10").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C11").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C12").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C13").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C14").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C15").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C16").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C17").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C18").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C19").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C20").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C21").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C22").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("C23").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Id Show").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Str File Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Str Path").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Play Count").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Last Played").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Date Added").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Str Title").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Str Studio").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Premiered").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Mpaa").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Resume Time In Seconds").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Total Time In Seconds").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Id Season").'</td>';	
	}
	else
	{
		echo "<td>"."Id Episode"."</td>";
		echo "<td>"."Id File"."</td>";
		echo "<td>"."C00"."</td>";
		echo "<td>"."C01"."</td>";
		echo "<td>"."C02"."</td>";
		...
		echo "<td>"."C23"."</td>";
		echo "<td>"."Id Show"."</td>";
		echo "<td>"."Str File Name"."</td>";
		echo "<td>"."Str Path"."</td>";
		echo "<td>"."Play Count"."</td>";
		echo "<td>"."Last Played"."</td>";
		echo "<td>"."Date Added"."</td>";
		echo "<td>"."Str Title"."</td>";
		echo "<td>"."Str Studio"."</td>";
		echo "<td>"."Premiered"."</td>";
		echo "<td>"."Mpaa"."</td>";
		echo "<td>"."Resume Time In Seconds"."</td>";
		echo "<td>"."Total Time In Seconds"."</td>";
		echo "<td>"."Id Season"."</td>";
	}
	echo "</tr>";
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		$values = array();
					...
					$values["premiered"] = $pageObject->getViewControl("premiered")->showDBValue($row, "");
					$values["mpaa"] = $pageObject->getViewControl("mpaa")->showDBValue($row, "");
					$values["resumeTimeInSeconds"] = $pageObject->getViewControl("resumeTimeInSeconds")->showDBValue($row, "");
					$values["totalTimeInSeconds"] = $pageObject->getViewControl("totalTimeInSeconds")->showDBValue($row, "");
					$values["idSeason"] = $pageObject->getViewControl("idSeason")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["c17"]);
					else
						echo $values["c17"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["lastPlayed"]);
					else
						echo $values["lastPlayed"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["strTitle"]);
					else
						echo $values["strTitle"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["strStudio"]);
					else
						echo $values["strStudio"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["premiered"]);
					else
						echo $values["premiered"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["mpaa"]);
					else
						echo $values["mpaa"];
			echo '</td>';
							echo '<td>';
			
									echo $values["resumeTimeInSeconds"];
			echo '</td>';
							echo '<td>';
			
									echo $values["totalTimeInSeconds"];
			echo '</td>';
							echo '<td>';
			
									echo $values["idSeason"];
			echo '</td>';
			echo "</tr>";
		}
