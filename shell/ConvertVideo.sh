...
convert() {
	...
	echo $cpath
	echo $preset
	find $spath -iname \*.mkv -exec HandBrakeCLI -i {} -o $cpath\'{-print %f}'.mkv $preset  _ {} \;
	find $spath -iname \*.avi -exec HandBrakeCLI -i {} -o $cpath\'{-print %f}'.mkv $preset  _ {} \;
	find $spath -iname \*.mp4 -exec HandBrakeCLI -i {} -o $cpath\'{-print %f}'.mkv $preset  _ {} \;
